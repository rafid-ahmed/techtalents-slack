                ...
                if(entity.expirytime > Date.now() + 60000) {
                  ...
                  web.im.replies({
                    ...
                    if (result.ok === true) {
                      ...
                      const fileurl = "https://europe-west1-tt-ekg.cloudfunctions.net/getSlackFile?path=" + req.body.event.files[0].url_private_download.substr("https://files.slack.com".length);
